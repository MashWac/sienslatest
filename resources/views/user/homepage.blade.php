...
@section('content')
        ...
        <div class="firstcont ">
            <div class="container-fluid">
                <h1 id="welcome">WELCOME TO <span id="companyname">SIENS&nbsp;&nbsp;<span class="logowel"><img src="/staticimg/fav.png" class="img-fluid" max-height="3vh"></span> AFRICA</span></h1>
            ...
            <div id="ourvalues">
                ...
                <div class="valuez">
                    <div class="imgpart">
                        <img src="/staticimg/fitness.png" class="img-fluid"  max-height="3vh">
                    </div>
                    <div class="valdesc">
                        <p>FITNESS</p>
                    </div>
                ...
                <div class="valuez">
                    <div class="imgpart">
                    <img src="/staticimg/health.png" class="img-fluid" max-height="3vh" >
                    </div>
                    <div class="valdesc">
                        <p>GOOD HEALTH</p>
                    </div>
                ...
                <div class="valuez">
                    <div class="imgpart">
                    <img src="/staticimg/strength.png" class="img-fluid" max-height="3vh" >
                    </div>
                    <div class="valdesc">
                        <p>STRENGTH</p>
                    </div>
                ...
                <div class="valuez">
                    <div class="imgpart">
                    <img src="/staticimg/organic.png" class="img-fluid" max-height="3vh" >
                    </div>
                    <div class="valdesc">
                        <p>NATURAL</p>
                    </div>
                ...
                <div class="valuez">
                    <div class="imgpart">
                    <img src="/staticimg/beauty.png" class="img-fluid" max-height="3vh" >
                    </div>
                    <div class="valdesc">
                        <p>BEAUTY</p>
                    </div>
